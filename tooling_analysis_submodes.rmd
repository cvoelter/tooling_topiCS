...
tooling_manu_by_group_evidence<-tooling.group.submode.manu.obs%>%
  ...
  mutate(group=fct_recode(group, "Old World Monkeys"="ow_monkeys", "New World Monkeys"="nw_monkeys", "Non-primate Mammals"="mammals","Gibbons"="lesser apes", "Great Apes"="great apes", "Invertebrates"="invertebrates", "Fish"="fish", "Amphibians"="amphibians","Reptiles"="reptiles", "Birds"="birds", "Prosimians"="prosimians"), tool_use_type=fct_recode(tool_use_type, "Manufacture"="submode_tooling_manu_obs", "Manufacture (anecdotal)"="submode_tooling_manu_ane", "Tooling"="submode_tooling_no_manu"))%>%
...
tooling_asso_by_group_evidence<-tooling.group.submode.asso.obs%>%
 ...
 mutate(group=fct_recode(group, "Old World Monkeys"="ow_monkeys", "New World Monkeys"="nw_monkeys", "Non-primate Mammals"="mammals","Gibbons"="lesser apes", "Great Apes"="great apes", "Invertebrates"="invertebrates", "Fish"="fish", "Amphibians"="amphibians","Reptiles"="reptiles", "Birds"="birds", "Prosimians"="prosimians"), tool_use_type=fct_recode(tool_use_type, "Associative Tooling"="submode_tooling_asso_obs", "Associative Tooling (anecdotal)"="submode_tooling_asso_ane", "Tooling"="submode_tooling_no_assoc"))%>%
...
ggsave(tooling.mode.plot_refs, filename = "graphs/Fig3_tooling_mode_by_group_number_references.pdf", height=7, width = 10, scale=0.66)
```
