...
tooling_by_group_evidence<-tooling.group.submode.obs%>%
  ...
  mutate(group=fct_recode(group, "old world monkeys"="ow_monkeys", "new world monkeys"="nw_monkeys", "non-primate mammals"="mammals", "gibbons"="lesser apes"), tool_use_type=fct_recode(tool_use_type, "Tool-use"="submode_notooling", "Tooling"="submode_tooling_obs", "Tooling (anecdotal)"="submode_tooling_ane"))
...
tooling_manu_by_group_evidence<-tooling.group.submode.manu.obs%>%
  ...
  mutate(group=fct_recode(group, "old world monkeys"="ow_monkeys", "new world monkeys"="nw_monkeys", "non-primate mammals"="mammals","gibbons"="lesser apes"), tool_use_type=fct_recode(tool_use_type, "Manufacture"="submode_tooling_manu_obs", "Manufacture (anecdotal)"="submode_tooling_manu_ane", "Tooling"="submode_tooling_no_manu"))%>%
...
tooling_asso_by_group_evidence<-tooling.group.submode.asso.obs%>%
  ...
  mutate(group=fct_recode(group, "old world monkeys"="ow_monkeys", "new world monkeys"="nw_monkeys", "non-primate mammals"="mammals","gibbons"="lesser apes"), tool_use_type=fct_recode(tool_use_type, "Associative Tooling"="submode_tooling_asso_obs", "Associative Tooling (anecdotal)"="submode_tooling_asso_ane", "Tooling"="submode_tooling_no_assoc"))%>%
  mutate(tool_use_type=relevel(tool_use_type,  "Tooling", "Associative Tooling (anecdotal)","Associative Tooling"  ))
...
tooling.group.submode.ref<-all.data%>%
  ...
  summarise(sum_submode_tooling=sum(submode_tooling))%>% mutate(group=fct_recode(group, "old world monkeys"="ow_monkeys", "new world monkeys"="nw_monkeys", "non-primate mammals"="mammals","gibbons"="lesser apes"))
...
ggsave(tooling.mode.plot_refs, filename = "graphs/Fig3_tooling_mode_by_group_number_references.png", height=7, width = 10, scale=0.66)
```
